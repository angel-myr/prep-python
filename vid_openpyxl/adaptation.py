...
# Adaptación al Video de openpyxl:
#  Se automatiza el reporte de sales.csv y catelog.csv
#  Determinando cantidad y total vendido por tipo de producto,
#  según cada tienda en tablas y gráficos automatizados

import pandas as pd
from openpyxl import load_workbook
from openpyxl.chart import BarChart, Reference

root_tabla_ventas = "C:/data/retail_dw/sales.csv"
root_tabla_catalogo = "C:/data/retail_dw/catalog.csv"

df_ventas = pd.read_csv(root_tabla_ventas)
df_catalogo = pd.read_csv(root_tabla_catalogo)
